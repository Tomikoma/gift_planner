...
_removePerson(BuildContext context) async {
    ...
    setState(() {
      Provider.of<DataModel>(context, listen: false).removePerson(widget.personId);
    });
    final path = join(
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
            ...
            child: ListTile(
              ...
              subtitle: Text(GiftPlannerLocalizations.of(context).personCardGiftNum + person.gifts.length.toString()),
